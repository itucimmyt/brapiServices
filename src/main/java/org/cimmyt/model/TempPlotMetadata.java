...
/**
 * The persistent class for the temp_plot_metadata database table.
 * 
 */
@Entity
@Table(name="temp_plot_metadata", schema="operational")
@NamedQuery(name="TempPlotMetadata.findAll", query="SELECT t FROM TempPlotMetadata t")
public class TempPlotMetadata implements Serializable {
