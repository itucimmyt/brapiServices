...
/**
 * The persistent class for the temp_entry_data database table.
 * 
 */
@Entity
@Table(name="temp_entry_data", schema="operational")
@NamedQuery(name="TempEntryData.findAll", query="SELECT t FROM TempEntryData t")
public class TempEntryData implements Serializable {
