...
/**
 * The persistent class for the cross_data database table.
 * 
 */
@Entity
@Table(name="cross_data", schema="operational")
@NamedQuery(name="CrossData.findAll", query="SELECT c FROM CrossData c")
