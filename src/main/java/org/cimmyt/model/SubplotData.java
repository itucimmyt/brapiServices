...
/**
 * The persistent class for the subplot_data database table.
 * 
 */
@Entity
@Table(name="subplot_data", schema="operational")
@NamedQuery(name="SubplotData.findAll", query="SELECT s FROM SubplotData s")
public class SubplotData implements Serializable {
